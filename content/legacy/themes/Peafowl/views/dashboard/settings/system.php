...
<div class="input-label">
    <label for="enable_xr"><?php _se('Enable %service%', ['%service%' => 'xrDebug']); ?></label>
    ...
    <div class="input-below"><?php _se('Enable this if you want to send debug messages to %xr%.', ['%xr%' => '<a href="https://xrdebug.com/" target="_blank" rel="external">xrDebug</a>']); ?></div>
</div>
<div id="xr-enable-combo">
    <div data-combo-value="1" class="switch-combo<?php if ((Handler::var('safe_post') ? Handler::var('safe_post')['enable_xr'] == 0 : !Settings::get('enable_xr'))) {
        ...
        <div class="input-label">
            <label for="xr_host"><?php _se('%s Host', 'xrDebug'); ?></label>
        ...
        <div class="input-label">
            <label for="xr_port"><?php _se('%s Port', 'xrDebug'); ?></label>
        ...
        <div class="input-label">
            <label for="xr_key"><?php _se('%s Key', 'xrDebug'); ?></label>
