...
echo read_the_docs_settings('upload-storage', _s('Upload storage')); ?>
<div class="input-label">
    <i class="fas fa-cloud margin-right-5"></i>
    <?php _se('This is the storage where uploads will be stored.'); ?>
</div>
<?php
