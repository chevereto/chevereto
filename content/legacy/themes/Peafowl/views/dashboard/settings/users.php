...
<div class="input-label">
    ...
    <div class="c5 phablet-c1"><select type="text" name="require_user_email_confirmation" id="require_user_email_confirmation" class="text-input"<?php if (getSetting('website_mode') == 'personal' || empty(getSetting('email_mode'))) {
                echo ' disabled';
            } ?>>
            <?php
    ...
    <?php email_mode_warning(); ?>
    <?php personal_mode_warning(); ?>
</div>
<div class="input-label">
    <label for="require_user_email_social_signup"><?php _se('Require email for social signup'); ?></label>
    <div class="c5 phablet-c1"><select type="text" name="require_user_email_social_signup" id="require_user_email_social_signup" class="text-input"<?php if (getSetting('website_mode') == 'personal' || empty(getSetting('email_mode'))) {
                echo ' disabled';
            } ?>>
            <?php
...
<div class="input-label">
    ...
    <div class="c5 phablet-c1"><select type="text" name="notify_user_signups" id="notify_user_signups" class="text-input"<?php if (empty(getSetting('email_mode'))) {
                echo ' disabled';
            } ?>>
            <?php
